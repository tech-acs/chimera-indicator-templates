...
namespace App\IndicatorTemplates\Enumerations;
 ...
 * @category BarChart
 */
abstract class PopulationEnumeratedByArea extends Chart implements BarChart
{
    public const POPULATION_DATA_KEY =[ 'area_code', 'population'];
    /**
     ...
     * ];
     */
    abstract protected function getPopulationCountedData(array $filter = []);

    abstract protected function getExpectedValues(array $filter = []);
